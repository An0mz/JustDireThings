...
public class MachineSettingsCopierScreen extends Screen {
    ...
    public void renderBackground(GuiGraphics guiGraphics) {
        ...
        guiGraphics.fill(topSectionLeft, topSectionTop - 20, topSectionLeft + topSectionWidth, topSectionTop, 0xC0000000);
        guiGraphics.fill(topSectionLeft, topSectionTop, topSectionLeft + topSectionWidth, topSectionTop + topSectionHeight, 0xC0000000);
