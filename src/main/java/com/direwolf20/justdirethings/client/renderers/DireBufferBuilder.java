...
public class DireBufferBuilder extends BufferBuilder {
	// This class exists because sorting in vanilla minecraft is the opposite of how
	// we want to do it
	...
	public void putSortedQuadIndices(VertexFormat.IndexType pIndexType) {
		if (this.sortingPoints != null && this.sorting != null) {
			...
			// Reverse the order of the sorted indices. The whole reason this class exists
			// is this one line!
