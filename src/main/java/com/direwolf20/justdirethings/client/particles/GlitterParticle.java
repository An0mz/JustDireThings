...
public class GlitterParticle extends TextureSheetParticle {
	...
	public GlitterParticle(ClientLevel level, double x, double y, double z, double targetX, double targetY,
			double targetZ, float size, float r, float g, float b, float a, float maxAgeMul, SpriteSet sprites) {
