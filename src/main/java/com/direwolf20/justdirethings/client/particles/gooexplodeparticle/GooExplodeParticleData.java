...
public class GooExplodeParticleData implements ParticleOptions {
	...
	public String writeToString() {
		return String.format(Locale.ROOT, "%s", this.getType());
	}
	...
	public static final Deserializer<GooExplodeParticleData> DESERIALIZER = new Deserializer<GooExplodeParticleData>() {
		@Nonnull
		@Override
		public GooExplodeParticleData fromCommand(ParticleType<GooExplodeParticleData> particleTypeIn,
		...
		@Override
		public GooExplodeParticleData fromNetwork(ParticleType<GooExplodeParticleData> particleTypeIn,
