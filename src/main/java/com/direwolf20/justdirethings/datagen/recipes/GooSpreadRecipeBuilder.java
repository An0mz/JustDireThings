...
public class GooSpreadRecipeBuilder implements RecipeBuilder {
	...
	public GooSpreadRecipeBuilder(ResourceLocation id, BlockState input, BlockState output, int tierRequirement,
	...
	public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
		this.save(pFinishedRecipeConsumer, new ResourceLocation(JustDireThings.MODID,
				BuiltInRegistries.BLOCK.getKey(this.output.getBlock()).getPath() + "-goospread"));
	}
	...
	public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pId) {
		...
		pFinishedRecipeConsumer.accept(
				new FinishedGooSpreadRecipe(pId, this.input, this.output, this.tierRequirement, this.craftingDuration));
	}
