...
public final class PolymorphicEntitySanitizer {
	// Cosmetic-only identity: variant + colour, no
	// inventory/equipment/ownership/age/health/trades.
	private static final Set<String> COSMETIC_FIELDS = Set.of("Variant", // axolotl, horse, llama, parrot, tropical fish
			"variant", // cow, pig, chicken, cat, frog, wolf
			"RabbitType", // rabbit
			"Color", // sheep, shulker
			"Sheared", // sheep
			"FromBucket", // axolotl, fish
