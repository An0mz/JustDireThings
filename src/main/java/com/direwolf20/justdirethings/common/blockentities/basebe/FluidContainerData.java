...
public class FluidContainerData implements ContainerData {
    ...
    public void set(int index, int value) {
        switch (index) {
            case 0 -> fluidMachineBE.setFluidStack(BuiltInRegistries.FLUID.byId(value), fluidMachineBE.getAmountStored());
            case 1 -> fluidMachineBE.setAmountStored((fluidMachineBE.getAmountStored() & 0xFFFF0000) | (value & 0xFFFF));
