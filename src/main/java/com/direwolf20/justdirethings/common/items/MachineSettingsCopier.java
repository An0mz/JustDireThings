...
public class MachineSettingsCopier extends Item {
    ...
    private static void openScreen(ItemStack stack) {
        net.minecraft.client.Minecraft.getInstance().setScreen(new com.direwolf20.justdirethings.client.screens.MachineSettingsCopierScreen(stack));
    }
    ...
    public void loadSettings(BlockEntity blockEntity, ItemStack itemStack) {
        ...
        if (tag == null || !tag.contains(COPIED_DATA_KEY)) return;
