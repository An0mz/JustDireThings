...
public class BaseBoots extends ArmorItem implements ToggleableTool, LeftClickableTool {
	...
	public static final AttributeModifier stepHeight = new AttributeModifier(STEPHEIGHT, "JustDireStepAssist", 1.0,
	...
	public void inventoryTick(@NotNull ItemStack itemStack, @NotNull Level level, @NotNull Entity entity, int itemSlot,
			boolean isSelected) {
		if (itemSlot == EquipmentSlot.FEET.getIndex() && !getPassiveTickAbilities(itemStack).isEmpty()
