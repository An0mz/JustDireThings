...
public class PacketHandler {
    ...
    public static void registerNetworking(final FMLCommonSetupEvent event) {
        CHANNEL = NetworkRegistry.newSimpleChannel(
                new ResourceLocation(JustDireThings.MODID, "main"),
                () -> PROTOCOL, PROTOCOL::equals, PROTOCOL::equals
        );

        // Server-bound packets
        CHANNEL.registerMessage(nextId(), AreaAffectingPayload.class,         AreaAffectingPayload::write,         AreaAffectingPayload::new,         AreaAffectingPacket::handle);
        CHANNEL.registerMessage(nextId(), BlockStateFilterPayload.class,      BlockStateFilterPayload::write,      BlockStateFilterPayload::new,      BlockStateFilterPacket::handle);
        CHANNEL.registerMessage(nextId(), ClickerPayload.class,               ClickerPayload::write,               ClickerPayload::new,               ClickerPacket::handle);
        CHANNEL.registerMessage(nextId(), DirectionSettingPayload.class,      DirectionSettingPayload::write,      DirectionSettingPayload::new,      DirectionSettingPacket::handle);
        CHANNEL.registerMessage(nextId(), DropperSettingPayload.class,        DropperSettingPayload::write,        DropperSettingPayload::new,        DropperSettingPacket::handle);
        CHANNEL.registerMessage(nextId(), EnergyTransmitterSettingPayload.class, EnergyTransmitterSettingPayload::write, EnergyTransmitterSettingPayload::new, EnergyTransmitterPacket::handle);
        ...
        CHANNEL.registerMessage(nextId(), SwapperPayload.class,               SwapperPayload::write,               SwapperPayload::new,               SwapperPacket::handle);
        CHANNEL.registerMessage(nextId(), TickSpeedPayload.class,             TickSpeedPayload::write,             TickSpeedPayload::new,             TickSpeedPacket::handle);
