...
/**
 * An EnergyStorage implementation that reads/writes its value directly to the ItemStack's NBT.
 * This ensures energy survives serialization/deserialization and is compatible with
 * other mods that use the standard "Energy" NBT key (e.g. filling via pipes/chargers).
 */
