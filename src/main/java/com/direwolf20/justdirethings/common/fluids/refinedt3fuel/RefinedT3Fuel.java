...
public abstract class RefinedT3Fuel extends ForgeFlowingFluid implements RefinedFuel {
	...
	private static ForgeFlowingFluid.Properties makeProperties() {
		return new ForgeFlowingFluid.Properties(() -> Registration.REFINED_T3_FLUID_TYPE.get(),
				() -> Registration.REFINED_T3_FLUID_SOURCE.get(), () -> Registration.REFINED_T3_FLUID_FLOWING.get())
