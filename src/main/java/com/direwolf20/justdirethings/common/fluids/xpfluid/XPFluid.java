...
public abstract class XPFluid extends ForgeFlowingFluid {
	...
	private static ForgeFlowingFluid.Properties makeProperties() {
		return new ForgeFlowingFluid.Properties(() -> Registration.XP_FLUID_TYPE.get(),
				() -> Registration.XP_FLUID_SOURCE.get(), () -> Registration.XP_FLUID_FLOWING.get())
				.bucket(() -> Registration.XP_FLUID_BUCKET.get()).block(() -> Registration.XP_FLUID_BLOCK.get());
	}
