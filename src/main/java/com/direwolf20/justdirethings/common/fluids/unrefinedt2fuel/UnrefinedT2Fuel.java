...
public abstract class UnrefinedT2Fuel extends ForgeFlowingFluid {
	...
	private static ForgeFlowingFluid.Properties makeProperties() {
		return new ForgeFlowingFluid.Properties(() -> Registration.UNREFINED_T2_FLUID_TYPE.get(),
				() -> Registration.UNREFINED_T2_FLUID_SOURCE.get(), () -> Registration.UNREFINED_T2_FLUID_FLOWING.get())
