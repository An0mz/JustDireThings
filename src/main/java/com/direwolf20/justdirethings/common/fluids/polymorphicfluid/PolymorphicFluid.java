...
public abstract class PolymorphicFluid extends ForgeFlowingFluid {
	...
	private static ForgeFlowingFluid.Properties makeProperties() {
		return new ForgeFlowingFluid.Properties(() -> Registration.POLYMORPHIC_FLUID_TYPE.get(),
				() -> Registration.POLYMORPHIC_FLUID_SOURCE.get(), () -> Registration.POLYMORPHIC_FLUID_FLOWING.get())
